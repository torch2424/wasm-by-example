...
Before we end this example, it is worth noting that [TinyGo offers a set of examples for learning as well](https://github.com/tinygo-org/tinygo/tree/master/src/examples/wasm). Which could also be super helpful and serve as another reference point!

Continuing on with WasmByExample, next let's take a deeper look at WebAssembly [Exports](/example-redirect?exampleName=exports).
