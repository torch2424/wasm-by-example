(module
 ...
 (global $index/INPUT_BUFFER_POINTER i32 (i32.const 0))
 (global $index/INPUT_BUFFER_SIZE i32 (i32.const 1024))
 (global $index/OUTPUT_BUFFER_POINTER i32 (i32.const 1024))
 (global $index/OUTPUT_BUFFER_SIZE i32 (i32.const 1024))
 ...
 (export "INPUT_BUFFER_POINTER" (global $index/INPUT_BUFFER_POINTER))
 (export "INPUT_BUFFER_SIZE" (global $index/INPUT_BUFFER_SIZE))
 (export "OUTPUT_BUFFER_POINTER" (global $index/OUTPUT_BUFFER_POINTER))
 (export "OUTPUT_BUFFER_SIZE" (global $index/OUTPUT_BUFFER_SIZE))
 ...
 (func $start:index (; 27 ;) (type $FUNCSIG$v)
  i32.const 1
  memory.grow
  drop
 )
 (func $index/amplifyAudioInBuffer (; 28 ;) (type $FUNCSIG$v)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  block $break|0
   ...
   loop $repeat|0
    ...
    i32.eqz
    br_if $break|0
    global.get $index/INPUT_BUFFER_POINTER
    local.get $0
    i32.add
    i32.load8_u
    local.set $1
    ...
    global.get $index/OUTPUT_BUFFER_POINTER
    local.get $0
    i32.add
    local.get $1
    i32.store8
